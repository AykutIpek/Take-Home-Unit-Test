...
final class CreateScreenUIValidTests: XCTestCase {
    ...
    func test_when_create_is_tapped_create_view_is_presented() {
        ...
        XCTAssertTrue(app.textFields["firstNameTxtFields"].exists)
        XCTAssertTrue(app.textFields["lastNameTxtFields"].exists)
        XCTAssertTrue(app.textFields["jobTxtFields"].exists)
    }
